...
import jmetal.problems.ZDT.ZDT3SC;
...
public class NSGAII_mainSC {
   ...
   */
  public NSGAII_mainSC(Resultado resultado, WangMendel wm, FormateSC formate, KeelSC keelTreinamento, KeelSC keelTeste, boolean desbalanceado) 
    ...
    problem = new ZDT3SC(wm, formate, keelTreinamento, desbalanceado);
    ...
    ProcessamentoSC p = ZDT3SC.p;
    p.gerandoRegras(cromossomo);
    SistemaFuzzyAGSC sistemaFuzzy = new SistemaFuzzyAGSC(p.novosPontosCentrais);
