...
public class SistemaFuzzyAGSC {
    ...
    public SistemaFuzzyAGSC(List<Double> pontosCentrais){
        this.jLogicFuzzy = "";
        this.pontosCentrais = pontosCentrais;
    }
    
    public void gerarFLC(KeelSC keel){
        ...
        try {
            ...
            Logger.getLogger(SistemaFuzzyAGSC.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    
    private void varInput(KeelSC keel) {
    ...
    private void varOutput(KeelSC keel) {
    ...
    private void fuzzify(KeelSC keel) {
