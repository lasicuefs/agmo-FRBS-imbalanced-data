 ...
 * </ul>
  https://github.com/Waikato/moa/blob/master/moa/src/main/java/moa/classifiers/core/driftdetection/HDDM_A_Test.java
 * @author Isvani Frias-Blanco (ifriasb@udg.co.cu)
 *
 */
...
public class HDDM_A_Test extends AbstractChangeDetector {
    ...
    public void input(double value) {
        ...
        //System.out.println("drif - " + driftConfidenceOption.getValue());
    ...
    private boolean meanIncr(double c_min, int n_min, double total_c, int total_n, double confianzaCambio) {
        //System.out.println(n_min + " - "+ total_n);
        if (n_min == total_n) {
            return false;
        }
        double m = (double) (total_n - n_min) / n_min * (1.0 / total_n);
        double cota = Math.sqrt(m / 2 * Math.log(2.0 / confianzaCambio));
        //System.out.println(total_c + " - "+ total_n+ " - "+ c_min + " - "+ n_min);
        //System.out.println((total_c / total_n - c_min / n_min) + " - " + cota);
    ...
    protected void updateEstimations() {
        //System.out.println(total_n + " - " + nEstimacion);
