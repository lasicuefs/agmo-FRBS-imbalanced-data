...
public class ArrayRealSolutionType extends SolutionType {
	 ...
	 */
        ...
        public boolean semente = true;
        
	public ArrayRealSolutionType(Problem problem, List<Double> cromossomo) {
		super(problem) ;
	...
	public Variable[] createVariables() {
		...
		if (this.semente){
                    System.out.println("Carregando Semente");
                    variables[0] = new ArrayReal(problem_.getNumberOfVariables(), problem_, this.cromossomo);
                    this.semente = false;
                }else{
