...
public class NSGAII extends Algorithm {
     ...
     */
    private double melhorInterp = 0;
    private double melhorAcc = 0;
    private int count = 0;
    ...
    public SolutionSet execute() throws JMException, ClassNotFoundException {
        ...
        while (evaluations < maxEvaluations) {
            ...
            accAux = -1*best.getObjective(0);
            interpAux = -1*best.getObjective(1);
            
            if(accAux > melhorAcc){
                melhorAcc = accAux;
                melhorInterp = interpAux;
                count = 0;
            }else if(accAux == melhorAcc && interpAux > melhorInterp){
                melhorAcc = accAux;
                melhorInterp = interpAux;
                count = 0;
            }else{
            ...
            for (int i = 0; i < (populationSize / 2); i++) {
                if (evaluations < maxEvaluations) {
                    ...
                    //System.out.println("Aqui " + parents[0].getDecisionVariables()[2]);
