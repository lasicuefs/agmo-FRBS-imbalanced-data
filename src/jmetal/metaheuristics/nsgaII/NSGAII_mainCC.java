...
import jmetal.problems.ZDT.ZDT3CC;
...
public class NSGAII_mainCC {
   ...
   */
  public List executarAG(WangMendel wm, KeelCC dataset, int indiceJanela, boolean desbalanceado) 
    ...
    problem = new ZDT3CC(wm, dataset, indiceJanela, desbalanceado);
    ...
    resultados.add(-1*best.getObjective(0)); //acuracia
    resultados.add(-1*best.getObjective(1));
    resultados.add(NSGAII.geracaoAtual);
